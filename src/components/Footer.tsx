      ...
      <div className="container py-28">
        <div className="grid gap-16 md:grid-cols-2 md:items-center">
          ...
          <div>
            ...
            <p className="mt-4 max-w-sm leading-relaxed text-sage-300">
              {site.heroLead}
            </p>
          </div>
          ...
          <div className="md:justify-self-end">
            ...
            <dl className="mt-6 space-y-4 text-lg">
              <div className="flex items-center gap-3">
                <dt className="w-16 text-xs uppercase tracking-widest text-sage-400">Tālr.</dt>
                <dd>
              ...
              <div className="flex items-center gap-3">
                <dt className="w-16 text-xs uppercase tracking-widest text-sage-400">E-pasts</dt>
                <dd>
              ...
              <div className="flex items-center gap-3">
                <dt className="w-16 text-xs uppercase tracking-widest text-sage-400">Adrese</dt>
        ...
        <div className="mt-20 flex flex-col gap-2 border-t border-sage-800 pt-8 text-sm text-sage-400 sm:flex-row sm:items-center sm:justify-between">
          <span>© {new Date().getFullYear()} {site.companyLegal}. Visas tiesības aizsargātas.</span>
          <span className="tracking-widest">{site.about.marketsCode}</span>
        </div>
      </div>
    </footer>
  );
